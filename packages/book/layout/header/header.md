...
**Conteúdo**
- Aceita conteúdo interno — o conteúdo principal do cabeçalho (ex: `<morph-text>`, `<morph-logo>`).
- Aceita slot nomeado `actions` — descreva o que vai dentro usando `slot="actions"` (ex: `<morph-button>`).
...
**Não use quando**
- Precisa de um rodapé → use `<morph-footer>`.
